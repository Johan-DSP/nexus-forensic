...
Generado: 2026-09-11 13:04:21
Archivos incluidos: 45
...
├── backend/app/api/chrono.py
├── backend/app/api/evidentia.py
...
├── backend/app/db/models/case.py
├── backend/app/db/models/chrono.py
├── backend/app/db/models/evidentia.py
├── backend/app/db/models/nexus.py
├── backend/app/main.py
├── backend/app/repositories/case_repo.py
├── backend/app/repositories/chrono_repo.py
├── backend/app/repositories/evidentia_repo.py
├── backend/app/schemas/case.py
├── backend/app/schemas/chrono.py
├── backend/app/schemas/evidentia.py
├── backend/app/services/chrono_service.py
...
├── storage/8581decdbef9429fafbfe665680b30d3.txt
├── storage/8f9a69c7700841f0bb4be3ecf186bf3f.txt
├── storage/a94ca51aa49b40ee8b3a5a7dedd36976.txt
├── storage/b28dd1400d334632adeea9a0fea3ce75.txt
├── storage/e8747a4d8a0c44408c3af8958dd1994f.txt
```

## 2. ARCHIVOS DEL PROYECTO

Cada archivo aparece una sola vez. Los binarios, bases de datos, dependencias instaladas, archivos sensibles y artefactos generados fueron excluidos.
...
### FILE: `backend/app/api/chrono.py`
...
### FILE: `backend/app/api/evidentia.py`
...
# Conexión adaptada para SQLite en desarrollo
...
### FILE: `backend/app/db/models/case.py`
...
### FILE: `backend/app/db/models/chrono.py`
...
### FILE: `backend/app/db/models/evidentia.py`
...
### FILE: `backend/app/db/models/nexus.py`
...
### FILE: `backend/app/repositories/case_repo.py`
...
### FILE: `backend/app/repositories/chrono_repo.py`
...
### FILE: `backend/app/repositories/evidentia_repo.py`
...
### FILE: `backend/app/schemas/chrono.py`
...
### FILE: `backend/app/schemas/evidentia.py`
...
### FILE: `backend/app/services/chrono_service.py`
...
### FILE: `backend/app/services/hashing_service.py`
...
### FILE: `storage/8581decdbef9429fafbfe665680b30d3.txt`

```text
Archivo de evidencia generado para demostración. ID: 2
```


### FILE: `storage/8f9a69c7700841f0bb4be3ecf186bf3f.txt`

```text
Archivo de evidencia generado para demostración. ID: 5
```


### FILE: `storage/a94ca51aa49b40ee8b3a5a7dedd36976.txt`

```text
Archivo de evidencia generado para demostración. ID: 4
```


### FILE: `storage/b28dd1400d334632adeea9a0fea3ce75.txt`

```text
Archivo de evidencia generado para demostración. ID: 3
```


### FILE: `storage/e8747a4d8a0c44408c3af8958dd1994f.txt`

```text
Archivo de evidencia generado para demostración. ID: 1
```
